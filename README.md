...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-23 09:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0c4feb73-eaa9-4833-9957-49a9a63a613a.git
$ cd 0c4feb73-eaa9-4833-9957-49a9a63a613a
```
